...
class AndroidImage extends React.Component {
    static propTypes = {
                    ...
                    (this.state.isLoaded && !this.state.isError) ? children :
                        ...
                        >
                            ...
                            <Image
                                ...
                                source={placeholderSource ? placeholderSource : require('gsresource/img/dressDefaultPic110.png')}
                            />
                        </View>
                }
                {
